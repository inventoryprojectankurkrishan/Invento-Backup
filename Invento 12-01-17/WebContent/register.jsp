					...
					<form method="POST" action="login" >
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<s:textfield name="firstname" placeholder="Name" maxlength="50" cssClass="form-control input-lg" required="" />
						</div>
						<div class="form-group">
							<label class="control-label" for="signupEmail">Middle Name</label>
							<input id="signupEmail" type="email" maxlength="50" class="form-control">
						</div>
						<div class="form-group">
							<label class="control-label" for="signupUsername">Last Name</label>
						...
						<div class="form-group">
							<s:submit id="register" type="submit" value="Create your account" class="btn btn-info btn-block"></s:submit>
						</div>
